                    ...
                    <div className="md:flex">
                        ...
                        <div className="p-6 md:flex-1">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href="tel:+17077084062" className="inline-block border border-blue-600 text-blue-600 px-3 py-2 rounded-md hover:bg-blue-50">Call</a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <li key={b.id} className="bg-white shadow-sm hover:shadow-lg transform transition hover:-translate-y-1 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4 border-t bg-white">
                            <div className="flex items-center justify-between">
                                ...
                                <a href="tel:+17077084062" className="hidden md:inline-block bg-blue-600 text-white px-3 py-1.5 rounded-md font-semibold hover:bg-blue-700">Call</a>
                            </div>
                        </div>
                    </li>
                ))}
