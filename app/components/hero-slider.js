    ...
    const slides = [
        {
            id: 1,
            content: {
                badge: "Open for paid projects",
                mainHeadline: "WEBSITES THAT",
                highlightedWord: "get customers",
                subHeadline: "FOR YOUR BUSINESS",
                subtitle: "SmartSoft Solutions builds marketing sites, e-commerce stores, and full-stack apps with Next.js and React. You get a live product — not a demo — quoted up front and built to launch.",
                cta: "Start a Project",
                icon: (
                    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                        <rect x="10" y="18" width="100" height="72" rx="10" fill="#FDE68A" fillOpacity="0.15" stroke="#F59E0B" strokeWidth="2" />
                        <rect x="18" y="28" width="84" height="8" rx="4" fill="#F59E0B" fillOpacity="0.35" />
                        <rect x="18" y="44" width="50" height="6" rx="3" fill="#FCD34D" fillOpacity="0.7" />
                        <rect x="18" y="56" width="64" height="6" rx="3" fill="#FCD34D" fillOpacity="0.55" />
                        <rect x="18" y="68" width="40" height="6" rx="3" fill="#FCD34D" fillOpacity="0.4" />
                        <rect x="72" y="52" width="30" height="30" rx="8" fill="#F59E0B" fillOpacity="0.25" />
                        <path d="M82 67 L88 73 L98 61" stroke="#F59E0B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                )
            },
        },
        {
            ...
            content: {
                ...
                mainHeadline: "STORES BUILT",
                highlightedWord: "to take orders",
                subHeadline: "CATALOG · CART · CHECKOUT",
                subtitle: "Product catalogs, offers, carts, and checkout flows designed for conversion — with real payments and mobile shopping UX your customers actually use.",
                cta: "See Store Work",
                icon: (
                    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                        <rect x="20" y="25" width="80" height="70" rx="12" fill="#FDE68A" fillOpacity="0.12" />
                        <rect x="32" y="38" width="24" height="28" rx="4" fill="#F59E0B" fillOpacity="0.35" />
                        <rect x="64" y="38" width="24" height="28" rx="4" fill="#F59E0B" fillOpacity="0.2" />
                        <rect x="32" y="74" width="56" height="10" rx="5" fill="#F59E0B" />
                        <circle cx="88" cy="30" r="14" fill="#F59E0B" fillOpacity="0.25" />
                        <text x="88" y="35" textAnchor="middle" fontSize="14" fill="#F59E0B" fontWeight="bold">$</text>
                    </svg>
                )
            },
        },
        {
            id: 3,
            content: {
                badge: "Web Apps & Dashboards",
                mainHeadline: "SOFTWARE YOUR",
                highlightedWord: "team can use",
                subHeadline: "LOGIN · DASHBOARDS · FLOWS",
                subtitle: "Login, dashboards, and product flows with Firebase or Supabase — operational tools your team and customers can rely on every day.",
                cta: "Get a Quote",
                icon: (
                    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                        <rect x="12" y="20" width="96" height="80" rx="12" fill="#FDE68A" fillOpacity="0.12" />
                        <rect x="22" y="32" width="28" height="56" rx="6" fill="#F59E0B" fillOpacity="0.2" />
                        <rect x="58" y="32" width="40" height="16" rx="4" fill="#F59E0B" fillOpacity="0.35" />
                        <rect x="58" y="56" width="40" height="32" rx="4" fill="#FCD34D" fillOpacity="0.25" />
                        <circle cx="36" cy="44" r="6" fill="#F59E0B" />
                        <rect x="28" y="58" width="16" height="4" rx="2" fill="#FCD34D" fillOpacity="0.7" />
                        <rect x="28" y="68" width="12" height="4" rx="2" fill="#FCD34D" fillOpacity="0.5" />
                    </svg>
                )
            },
        }
                        ...
                        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl">
                            ...
                            <div className="order-2 lg:order-1 text-center lg:text-left">
                                ...
                                <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-3">
                                    {["Next.js", "React", "Firebase", "Supabase"].map((badge) => (
