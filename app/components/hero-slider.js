  ...
  return (
    <section className="relative min-h-[88vh] md:min-h-[92vh] overflow-hidden bg-[#081220] text-white">
      <div className="absolute inset-0 lg:hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#081220]/80 via-[#081220]/35 to-[#081220]/45" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-5 lg:px-6 pt-24 pb-14 md:pt-28 md:pb-24 flex min-h-[88vh] md:min-h-[92vh] items-end md:items-center">
