...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-16 max-w-3xl">
      ...
      <p className="mb-4">You have the right to access, correct, or delete your personal information. Contact us at smartsoft.solutions0@gmail.com for any privacy-related requests.</p>
