                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className={`max-w-5xl mx-auto text-center transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl mb-10 shadow-2xl">
                            ...
                            <span className="text-[10px] uppercase tracking-[0.3em] font-black text-white/80">Premium Web Engineering in NYC</span>
                        </div>
                            ...
                            <div className="relative aspect-square rounded-[3rem] overflow-hidden border border-slate-100 shadow-2xl">
                                ...
                                <div className="absolute bottom-10 left-10">
                                    <div className="bg-white/90 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/20">
                                        <p className="text-yellow-600 font-black uppercase text-[10px] tracking-widest mb-2">Performance Metric</p>
                                        <h3 className="text-slate-900 text-xl font-black tracking-tight uppercase">99.9% Architecture Reliability</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-32 bg-slate-50 relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-24">
                        <h2 className="text-4xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter mb-6">Our Web <span className="text-yellow-500 italic font-serif lowercase">expertise</span></h2>
                        <p className="text-slate-500 text-lg max-w-2xl mx-auto font-medium">Comprehensive development solutions for every stage of your digital journey.</p>
                    </div>
