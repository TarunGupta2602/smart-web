...
export const HOME_FAQS = [
  {
    ...
    answer:
      'Starter bands: business websites from ₹5,000, e-commerce stores from ₹10,000, and custom web apps from ₹15,000. Final price follows scope — SmartSoft Solutions always sends a fixed quote before any build starts.',
  },
  {
