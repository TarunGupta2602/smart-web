...
export function localBusiness({
    ...
    return {
        ...
        '@id': url,
        name,
        description: description || 'SmartSoft Solutions builds business websites, e-commerce stores, and web apps with Next.js and React for companies that need a live product.',
        url,
        telephone,
        openingHours,
        priceRange,
        ...
        hasOfferCatalog: {
            ...
            itemListElement: [
                ...
                { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Web Apps & Dashboards' } },
