...
const INDIA_SERVICE_CITIES = [
    ...
    'Pune', 'Ahmedabad', 'Jaipur', 'Noida', 'Gurugram', 'Chandigarh',
...
export function localBusiness({
    ...
    return {
        ...
        '@id': `${url}#business`,
        name,
        description: description || 'SmartSoft Solutions is a remote website development company building business websites, e-commerce stores, and web apps with Next.js and React for companies that need a live product.',
        url,
        telephone,
        email,
        openingHours,
