...
export const PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    result: "1-on-1 WebRTC video matching with no signup wall",
    challenge:
      "Launch a browser-based random video chat product that feels instant, stays 18+, and can grow discovery through SEO landing pages.",
    approach:
      "We shipped peer-to-peer WebRTC sessions, queue matching, skip/report controls, and a content layer for alternatives and safety guides at parvah.online.",
    description:
      "Free random video chat platform — WebRTC peer-to-peer sessions, instant stranger matching, report/skip controls, and SEO landing pages for discovery. Built and shipped by SmartSoft Solutions at parvah.online.",
