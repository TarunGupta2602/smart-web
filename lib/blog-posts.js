...
export const BLOG_POSTS = [
  {
    ...
    title: "NFC + QR Table Ordering: The Complete System vs a PDF Menu",
    author: AUTHOR,
    date_posted: "2026-09-18",
    updated_at: "2026-09-18",
    image:
      "/nfc/nfc-qr-ordering-storyboard.png",
    meta_title: "Complete NFC QR Table Ordering for Restaurants",
    meta_description:
      "The complete NFC + QR restaurant system: tap or scan, live menu, cart, unique table links, and a staff dashboard. Not a PDF menu. Built for Indian restaurants.",
    meta_keywords:
      "complete NFC QR restaurant ordering system India, NFC digital menu India, QR table ordering, restaurant dashboard, contactless menu no app",
    description:
      "Most Indian restaurants still print a menu or hide a PDF behind a QR. This guide covers the complete NFC + QR table-ordering system SmartSoft is building — tap, cart, table identity, kitchen board.",
    content: `Most Indian restaurants still run tables on a **printed card** or a **QR that opens a PDF**. That is a brochure on a phone. The kitchen still writes tickets by hand.

SmartSoft Solutions is building the **complete NFC + QR table-ordering system** for Indian restaurants — not a sticker, not a theme. One product covers the whole loop: tap or scan, live menu with photos and prices, guest cart, **unique table links**, and a staff dashboard that shows table number, items, quantity, total, and status (accepted → preparing → ready → completed). No guest app.

We are opening a **free pilot for 1–2 restaurants** so this full loop runs with real customers before payments, WhatsApp alerts, and kitchen screens. Product page: [complete NFC + QR ordering system](/services/nfc-digital-menu).
